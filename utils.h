...
void inicioSesion(){
    ...
    do {
        ...
        cout << wall << "                                                   " << wall << endl;
        gotoxy(50,4);
        cout << wall << "                    BIENVENIDO                     " << wall << endl;
        gotoxy(50,5);
        cout << wall << "                                                   " << wall << endl;
        gotoxy(50,6);
        ...
        gotoxy(50,10);
        cout << wall << "  2. CREACION DE CUENTA             (-__-)         " << wall << endl; 
        gotoxy(50,11);
        cout << wall << "  3. SALIR                         ( >__< )        " << wall << endl;
        gotoxy(50,12);
        cout << wall << "                                   ^^ ~~ ^^        " << wall << endl;
        gotoxy(50,14);
...
void crearCita(Paciente paciente) {
    ...
    gotoxy(50,7);
    cout << "Mostrando seleccion de medicos, especialista y horarios..." << endl;
    system("pause");
